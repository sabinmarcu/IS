...
(function(/*! Stitch !*/) {
...
}).call(this)({"DefineProperty": function(exports, require, module) {(function() {
  var DefineProperty, dp, _root,
    __slice = [].slice;
  ...
  DefineProperty = (function() {
    ...
    DefineProperty.prototype.define = function(property, getter, setter, parent) {
      if (parent == null) {
        parent = _root;
      }
      this.defineSetter(property, setter, parent);
      return this.defineGetter(property, getter, parent);
    };

    DefineProperty.prototype.defineSetter = function(property, setter, parent) {
      if (parent == null) {
        parent = _root;
      }
      if ((property != null) && (setter != null) && (parent != null)) {
        return parent.__defineSetter__(property, setter);
      }
    };

    DefineProperty.prototype.defineGetter = function(property, getter, parent) {
      if (parent == null) {
        parent = _root;
      }
      if ((property != null) && (getter != null) && (parent != null)) {
        return parent.__defineGetter__(property, getter);
      }
    };
  ...
  module.exports = function() {
    ...
    return dp.define.apply(dp, args);
  };

  module.exports.extend = {
    define: function(prop, getter, setter, parent) {
      if (parent == null) {
        parent = this.prototype;
      }
      return dp.define.apply(this, [prop, getter, setter, parent]);
    },
    defineSetter: function(prop, setter, parent) {
      if (parent == null) {
        parent = this.prototype;
      }
      return dp.defineSetter.apply(this, [prop, setter, parent]);
    },
    defineGetter: function(prop, getter, parent) {
      if (parent == null) {
        parent = this.prototype;
      }
      return dp.defineGetter.apply(this, [prop, getter, parent]);
    }
  };

}).call(this);
}, "Enum": function(exports, require, module) {(function() {
  var Enum;
...
}, "ErrorReporter": function(exports, require, module) {// Generated by CoffeeScript 1.7.1
(function() {
  var ErrorReporter,
  ...
  Modules.ORM = (function() {
    ...
    ORM.prototype["delete"] = function(which) {
      ...
      return (_base1 = this._symlinks)[which] != null ? _base1[which] : _base1[which] = null;
    };
...
}, "Modules/Overwrite": function(exports, require, module) {(function() {
  var Modules, ow, random;
  ...
  random = function() {
    if (Math.uuid != null) {
      ...
      return new parseInt(Date().getTime());
    }
  };

  Modules.Overwrite = (function() {
    function Overwrite() {}

    Overwrite.prototype.overwrite = function(method, replacement, parent) {
      var prev;
      prev = parent[method];
      return (function(prev, parent, replacement, method) {
        return parent[method] = function() {
          this._super_ = prev;
          return replacement.apply(this, arguments);
        };
      })(prev, parent, replacement, method);
    };
  ...
  module.exports = Modules.Overwrite.prototype.overwrite;

  module.exports._extend_ = {
    _overwrite_: function(method, replacement, parent) {
      if (parent == null) {
        parent = this.prototype;
      }
      return ow.overwrite.call(this, method, replacement, parent);
    }
  };
  ...
  Obiect = (function() {
    ...
    Obiect.log = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (((typeof IS !== "undefined" && IS !== null) && IS.isDev) || ((typeof window !== "undefined" && window !== null) && window.isDev) || ((typeof root !== "undefined" && root !== null) && root.isDev) || (typeof isDev !== "undefined" && isDev !== null)) {
        args.unshift("");
  ...
  Promise = (function() {
    ...
    Promise.prototype.resolve = function() {
      ...
      if (callback && callback.ok) {
        ...
        time = setTimeout((function(_this) {
          return function() {
            clearTimeout(time);
...
(function () {
  ...
  IS = {
    ...
    Modules: {
      ...
      Overwrite: require('Modules/Overwrite'),
